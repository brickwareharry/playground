...
class Program
{
    ...
    {
        Console.WriteLine(Collinearity(1, 1, 1, 1));
        Console.WriteLine(Collinearity(1, 2, 2, 4));
        Console.WriteLine(Collinearity(1, 1, 6, 1));
        Console.WriteLine(Collinearity(1, 2, -1, -2));
        Console.WriteLine(Collinearity(1, 2, 1, -2));
        Console.WriteLine(Collinearity(4, 0, 11, 0));
        Console.WriteLine(Collinearity(0, 1, 6, 0));
        Console.WriteLine(Collinearity(4, 4, 0, 4));
        Console.WriteLine(Collinearity(0, 0, 0, 0));
        Console.WriteLine(Collinearity(0, 0, 1, 0));
        Console.WriteLine(Collinearity(5, 7, 0, 0));
    ...
    public static bool Collinearity(int x1, int y1, int x2, int y2)
    {
        ...
        // Calculate the cross product of the two vectors (x1, y1) and (x2, y2)
        // The vectors are collinear if the cross product is 0.
